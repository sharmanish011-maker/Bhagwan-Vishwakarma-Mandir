...
<section class="section-padding bg-maroon">
    <div class="container text-center">
        <span class="event-category-badge mb-3 d-inline-block" style="background:rgba(255,215,0,0.2);color:var(--gold-light);">⭐ Featured Event</span>
...
<section class="section-padding">
    <div class="container">
        <div class="filter-buttons mb-4 fade-in-up">
            ...
            <button class="filter-btn" data-category="festival" data-target=".event-filter-item">Festivals</button>
            <button class="filter-btn" data-category="puja" data-target=".event-filter-item">Puja</button>
            <button class="filter-btn" data-category="cultural" data-target=".event-filter-item">Cultural</button>
            <button class="filter-btn" data-category="community" data-target=".event-filter-item">Community</button>
        </div>
        <?php if (!empty($events)): ?>
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 event-filter-item filter-item fade-in-up" data-category="<?= e($event['category']) ?>">
                <div class="event-card">
                    <div class="event-image"><i class="fas fa-calendar-star"></i></div>
        ...
        <?php else: ?>
        <div class="text-center py-5"><i class="fas fa-calendar text-muted" style="font-size:3rem;"></i><p class="text-muted mt-3">No events at this time.</p></div>
        <?php endif; ?>
    </div>
</section>
